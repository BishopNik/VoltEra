(() => {
  ...
  const I18N_MESSAGES = {
    uk: {
      ...
      'reviews.eyebrow': '/ 08 — Відгуки клієнтів',
      'reviews.title': 'Досвід клієнтів.<br><em>Без перебільшень.</em>',
      'reviews.note': 'Відгуки публікуємо без редагування змісту. Позначка «Перевірений» з’являється лише після підтвердження в CRM.',
    ...
    en: {
      ...
      'reviews.eyebrow': '/ 08 — Customer reviews',
      'reviews.title': 'Customer experience.<br><em>Without exaggeration.</em>',
      'reviews.note': 'Reviews are published without editing their meaning. The “Verified” label appears only after confirmation in CRM.',
